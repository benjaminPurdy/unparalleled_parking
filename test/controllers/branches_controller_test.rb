...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { parent: @branch.parent, range: @branch.range, text: @branch.text, uid: @branch.uid }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { parent: @branch.parent, range: @branch.range, text: @branch.text, uid: @branch.uid }
    assert_redirected_to branch_path(assigns(:branch))
  end
